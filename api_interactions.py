...
def create_cloud_appliance(self, project_id: str, position: Tuple[float, float], 
                         template_id: str = "39e257dc-8412-3174-b6b3-0ee3ed6a43e9") -> Dict[str, Any]:
    """Create a cloud appliance in the project."""
    data = {
        "x": position[0],
        "y": position[1],
        "compute_id": "local"
...
def update_cloud_interfaces(self, project_id: str, node_id: str,
                          interfaces: List[Dict[str, Any]] = None) -> Dict[str, Any]:
    """Update cloud node interfaces."""
    if interfaces is None:
        # Default interfaces configuration
        interfaces = [
            {"interface": "ens33", "name": "ens33", "port_number": 0, "type": "ethernet"},
            {"interface": "virbr0", "name": "virbr0", "port_number": 1, "type": "ethernet"}
        ]
...
def set_node_mac_address(self, project_id: str, node_id: str, mac_address: str) -> Dict[str, Any]:
    """Set the MAC address for a node."""
    data = {
        "properties": {
